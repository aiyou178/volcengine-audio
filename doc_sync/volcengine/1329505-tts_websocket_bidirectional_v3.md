...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python调用示例" key="ehYS9EUXEV"><RenderMd content={`
### 前提条件
...
<Tabs.TabPane title="Java调用示例" key="uoP11ylRUk"><RenderMd content={`
### 前提条件
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go调用示例" key="SnltpcwtqD"><RenderMd content={`
### 前提条件
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="C#调用示例" key="e6ybjf6msn"><RenderMd content={`
### 前提条件
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="TypeScript调用示例" key="cSnHnumYHF"><RenderMd content={`
### 前提条件
